    ...
    <div className="repo_container">
      <div className="profile-item">
        ...
        <div className="profile-row">
          ...
          <div className="profile-row-title-description">{repoInfo.full_name}</div>
        </div>
        <div className="profile-row">
          <div className="profile-row-title">Language</div>
          <div className="profile-row-title-description">{repoInfo.language}</div>
        </div>
        ...
        {repoInfo.description === null ? (
          ...
          <div className="profile-row">
            ...
            <div className="profile-row-title-description">{repoInfo.description}</div>
          </div>
        )}
        <div className="profile-row">
          <div className="profile-row-title">Created_at</div>
          <div className="profile-row-title-description">{repoInfo.created_at}</div>
        </div>
      </div>
    </div>
  );
